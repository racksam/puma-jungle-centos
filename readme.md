该脚本是综合[puma-jungle](https://github.com/puma/puma/tree/master/tools/jungle)和[niwo/puma](https://gist.github.com/niwo/4526179)两个脚本后、加上自己的试验结果做出的整理。主要目的是简化CentOS下nginx+puma组合的启动配置。
